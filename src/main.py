...
from .security.security import get_security_manager, get_audit_logger
...
from .service.rate_limiting import get_rate_limiter, RateLimitConfig, RateLimitResult, DEFAULT_CONFIG, PREMIUM_CONFIG, ENTERPRISE_CONFIG
from .service.trial_service import get_trial_service
...
from .service.enhanced_notification_service import enhanced_notification_service
...
try:
    from .db.supabase_config import init_db
    init_db()
except Exception as e:
...
async def get_user_balance(user: dict = Depends(get_authenticated_user)):
    try:
        ...
        from .service.trial_validation import validate_trial_access
...
async def update_user_api_key_endpoint(
    ...
    try:
        ...
        if request.action == 'rotate':
            ...
            try:
                from .db.db_security import bulk_rotate_user_keys
...
async def get_user_audit_logs(
    ...
    try:
        ...
        # Get audit logs
        from .db.db_security import get_audit_logs
    ...
    try:
        ...
        try:
            ...
            if trial_validation.get('is_trial') and not trial_validation.get('is_expired'):
                try:
                    from .service.trial_validation import track_trial_usage
