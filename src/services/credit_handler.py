"""Back-compat alias for ``src.services.billing.credit_handler``.
...
from src.services.billing.credit_handler import *  # noqa: F401,F403
from src.services.billing.credit_handler import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.billing.credit_handler"]
