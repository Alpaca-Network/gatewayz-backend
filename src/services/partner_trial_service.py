"""Back-compat alias for ``src.services.billing.partner_trial_service``.

The module moved into the ``billing`` sub-package. This shim keeps the old
...
from src.services.billing.partner_trial_service import *  # noqa: F401,F403
from src.services.billing.partner_trial_service import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.billing.partner_trial_service"]
