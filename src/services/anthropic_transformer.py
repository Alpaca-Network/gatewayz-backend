"""Back-compat alias for ``src.services.providers.anthropic_transformer``.
...
from src.services.providers.anthropic_transformer import *  # noqa: F401,F403
from src.services.providers.anthropic_transformer import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.providers.anthropic_transformer"]
