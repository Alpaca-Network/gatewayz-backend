"""Back-compat alias for ``src.services.monitoring.health_snapshots``.
...
from src.services.monitoring.health_snapshots import *  # noqa: F401,F403
from src.services.monitoring.health_snapshots import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.monitoring.health_snapshots"]
