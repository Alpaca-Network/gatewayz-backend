    ...
    def _load_default_capabilities(self) -> None:
        ...
        defaults = {
            "openai/gpt-4o-mini": ModelCapabilities(
                ...
                provider="openai",
                tools=True, json_mode=True, json_schema=True, vision=True,
                max_context=128000, tool_schema_adherence="high",
            ...
            "anthropic/claude-3-haiku": ModelCapabilities(
                ...
                provider="anthropic",
                tools=True, json_mode=True, json_schema=False, vision=True,
                max_context=200000, tool_schema_adherence="high",
            ...
            "google/gemini-flash-1.5": ModelCapabilities(
                ...
                provider="google",
                tools=True, json_mode=True, json_schema=False, vision=True,
                max_context=1000000, tool_schema_adherence="medium",
                cost_per_1k_input=0.000075, cost_per_1k_output=0.0003,
            ),
            "deepseek/deepseek-chat": ModelCapabilities(
                model_id="deepseek/deepseek-chat",
                provider="deepseek",
                tools=True, json_mode=True, json_schema=False, vision=False,
                max_context=64000, tool_schema_adherence="medium",
            ...
            "mistral/mistral-small": ModelCapabilities(
                ...
                provider="mistral",
                tools=True, json_mode=True, json_schema=False, vision=False,
                max_context=32000, tool_schema_adherence="medium",
            ...
            "meta-llama/llama-3.1-8b-instant": ModelCapabilities(
                ...
                provider="meta",
                tools=False, json_mode=True, json_schema=False, vision=False,
                max_context=8192, tool_schema_adherence="low",
