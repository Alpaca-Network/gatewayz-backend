"""Back-compat alias for ``src.services.metrics.metrics_aggregator``.
...
from src.services.metrics.metrics_aggregator import *  # noqa: F401,F403
from src.services.metrics.metrics_aggregator import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.metrics.metrics_aggregator"]
