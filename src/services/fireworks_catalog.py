"""Back-compat alias for ``src.services.providers.fireworks_catalog``.
...
from src.services.providers.fireworks_catalog import *  # noqa: F401,F403

sys.modules[__name__] = sys.modules["src.services.providers.fireworks_catalog"]
