"""Back-compat alias for ``src.services.metrics.grafana_metrics_service``.
...
from src.services.metrics.grafana_metrics_service import *  # noqa: F401,F403
from src.services.metrics.grafana_metrics_service import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.metrics.grafana_metrics_service"]
