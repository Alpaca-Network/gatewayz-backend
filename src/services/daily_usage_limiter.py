"""Back-compat alias for ``src.services.billing.daily_usage_limiter``.
...
from src.services.billing.daily_usage_limiter import *  # noqa: F401,F403
from src.services.billing.daily_usage_limiter import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.billing.daily_usage_limiter"]
