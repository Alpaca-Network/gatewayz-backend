"""Back-compat alias for ``src.services.billing.payments``.
...
from src.services.billing.payments import *  # noqa: F401,F403
from src.services.billing.payments import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.billing.payments"]
