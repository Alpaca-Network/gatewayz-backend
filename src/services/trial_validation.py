"""Back-compat alias for ``src.services.billing.trial_validation``.
...
from src.services.billing.trial_validation import *  # noqa: F401,F403
from src.services.billing.trial_validation import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.billing.trial_validation"]
