"""Back-compat alias for ``src.services.metrics.prometheus_metrics``.
...
from src.services.metrics.prometheus_metrics import *  # noqa: F401,F403
from src.services.metrics.prometheus_metrics import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.metrics.prometheus_metrics"]
