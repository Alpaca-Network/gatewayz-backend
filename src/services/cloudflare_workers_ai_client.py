"""Back-compat alias for ``src.services.providers.cloudflare_workers_ai_client``.

The module moved into the ``providers`` sub-package. This shim keeps the old
...
from src.services.providers.cloudflare_workers_ai_client import *  # noqa: F401,F403
from src.services.providers.cloudflare_workers_ai_client import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.providers.cloudflare_workers_ai_client"]
