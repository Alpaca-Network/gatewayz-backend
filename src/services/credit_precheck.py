"""Back-compat alias for ``src.services.billing.credit_precheck``.
...
from src.services.billing.credit_precheck import *  # noqa: F401,F403
from src.services.billing.credit_precheck import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.billing.credit_precheck"]
