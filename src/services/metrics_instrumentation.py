"""Back-compat alias for ``src.services.metrics.metrics_instrumentation``.
...
from src.services.metrics.metrics_instrumentation import *  # noqa: F401,F403
from src.services.metrics.metrics_instrumentation import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.metrics.metrics_instrumentation"]
