"""Back-compat alias for ``src.services.monitoring.gateway_health_service``.
...
from src.services.monitoring.gateway_health_service import *  # noqa: F401,F403
from src.services.monitoring.gateway_health_service import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.monitoring.gateway_health_service"]
