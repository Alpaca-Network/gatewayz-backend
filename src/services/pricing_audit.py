"""Back-compat alias for ``src.services.pricing.pricing_audit``.
...
from src.services.pricing.pricing_audit import *  # noqa: F401,F403
from src.services.pricing.pricing_audit import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.pricing.pricing_audit"]
