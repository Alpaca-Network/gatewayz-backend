"""Back-compat alias for ``src.services.metrics.prometheus_pb2``.
...
from src.services.metrics.prometheus_pb2 import *  # noqa: F401,F403
from src.services.metrics.prometheus_pb2 import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.metrics.prometheus_pb2"]
