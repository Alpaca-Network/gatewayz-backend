"""Back-compat alias for ``src.services.cache.local_memory_cache``.
...
from src.services.cache.local_memory_cache import *  # noqa: F401,F403
from src.services.cache.local_memory_cache import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.cache.local_memory_cache"]
