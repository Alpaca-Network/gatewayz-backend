"""Back-compat alias for ``src.services.metrics.prometheus_exporter``.
...
from src.services.metrics.prometheus_exporter import *  # noqa: F401,F403
from src.services.metrics.prometheus_exporter import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.metrics.prometheus_exporter"]
