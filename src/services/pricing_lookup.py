"""Back-compat alias for ``src.services.pricing.pricing_lookup``.
...
from src.services.pricing.pricing_lookup import *  # noqa: F401,F403
from src.services.pricing.pricing_lookup import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.pricing.pricing_lookup"]
