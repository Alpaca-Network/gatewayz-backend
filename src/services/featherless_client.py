"""Back-compat alias for ``src.services.providers.featherless_client``.
...
from src.services.providers.featherless_client import *  # noqa: F401,F403
from src.services.providers.featherless_client import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.providers.featherless_client"]
