...
class StreamNormalizer:
    ...
    def normalize_chunk(self, chunk: Any) -> Optional[NormalizedChunk]:
    ...
    def _normalize_choice(self, choice: Any) -> Optional[Dict]:
    ...
    def _extract_reasoning(self, data: Dict) -> Optional[str]:
        fields = [
    ...
    def _normalize_finish_reason(self, reason: Any) -> Optional[str]:
        if not reason:
            return None
    ...
    def _normalize_anthropic_event(self, chunk: Dict) -> Optional[Dict]:
