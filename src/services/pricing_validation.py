"""Back-compat alias for ``src.services.pricing.pricing_validation``.

The module moved into the ``pricing`` sub-package. This shim keeps the old
...
from src.services.pricing.pricing_validation import *  # noqa: F401,F403
from src.services.pricing.pricing_validation import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.pricing.pricing_validation"]
