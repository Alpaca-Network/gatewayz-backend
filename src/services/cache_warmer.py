"""Back-compat alias for ``src.services.cache.cache_warmer``.
...
from src.services.cache.cache_warmer import *  # noqa: F401,F403
from src.services.cache.cache_warmer import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.cache.cache_warmer"]
