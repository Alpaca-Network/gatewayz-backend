"""Back-compat alias for ``src.services.monitoring.model_health_monitor``.
...
from src.services.monitoring.model_health_monitor import *  # noqa: F401,F403
from src.services.monitoring.model_health_monitor import __dict__ as _canonical_dict  # noqa: F401

sys.modules[__name__] = sys.modules["src.services.monitoring.model_health_monitor"]
