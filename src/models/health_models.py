...
class ModelHealthResponse(BaseModel):
    ...
    avg_response_time_ms: float | None = Field(None, description="Average response time in milliseconds")
...
class HealthSummaryResponse(BaseModel):
    ...
    providers: list[ProviderHealthResponse] = Field(default_factory=list, description="Provider health metrics")
    models: list[ModelHealthResponse] = Field(default_factory=list, description="Model health metrics")
...
class HealthDashboardResponse(BaseModel):
    ...
    providers: list[ProviderStatusResponse] = Field(default_factory=list, description="Provider statuses")
