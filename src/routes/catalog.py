...
async def get_specific_model(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get model data") from e
...
async def get_provider_top_models_endpoint(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get top models: {str(e)}") from e
...
async def compare_model_across_gateways(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to compare model: {str(e)}") from e
...
async def search_models(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to search models: {str(e)}") from e
