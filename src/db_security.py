...
def create_secure_api_key(user_id: int, key_name: str, environment_tag: str = 'live',
                         ...
                         expiration_days: int | None = None, max_requests: int | None = None,
                         ip_allowlist: list[str] | None = None, domain_referrers: list[str] | None = None,
...
def validate_secure_api_key(api_key: str, client_ip: str = None, referer: str = None, user_agent: str = None) -> dict[str, Any] | None:
    ...
    try:
        ...
        audit_logger.log_security_violation("INVALID_KEY", None, None, "Invalid API key provided", client_ip)
        return None
...
def check_key_name_uniqueness(user_id: int, key_name: str, exclude_key_id: int | None = None) -> bool:
