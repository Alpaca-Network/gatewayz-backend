...
This project is indexed by GitNexus as **gatewayz-backend** (26751 symbols, 56996 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
