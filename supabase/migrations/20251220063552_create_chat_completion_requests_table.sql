-- Migration: Create chat completion requests table
-- Created: 2025-12-20
-- Description: This migration creates a table to track all chat completion requests
--              including token usage, processing time, and model information.
