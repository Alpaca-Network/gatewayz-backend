...
**File**: `/root/repo/supabase/migrations/20260115000002_add_missing_model_pricing.sql`
...
git add supabase/migrations/20260115000002_add_missing_model_pricing.sql
