...
4. Copy and paste the contents of:
   ```
   supabase/migrations/20260115000002_add_missing_model_pricing.sql
   ```
...
# Or run directly
psql $DATABASE_URL < supabase/migrations/20260115000002_add_missing_model_pricing.sql
```
...
4. `supabase/migrations/20260115000002_add_missing_model_pricing.sql` - NEW
