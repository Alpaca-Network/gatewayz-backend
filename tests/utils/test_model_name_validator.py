...
class TestCleanModelName:
    ...
    def test_remove_parentheses_at_end(self):
        ...
        assert clean_model_name("Llama 4 Maverick Instruct (17Bx128E)") == "Llama 4 Maverick Instruct"
    ...
    def test_remove_both_colon_and_parentheses(self):
        ...
        assert clean_model_name("Swiss AI: Apertus 70B Instruct 2509 (free)") == "Apertus 70B Instruct 2509"
        # (INT4) at end is removed by end pattern
        assert clean_model_name("Intel: Qwen3 Coder 480B A35B Instruct (INT4)") == "Qwen3 Coder 480B A35B Instruct"
