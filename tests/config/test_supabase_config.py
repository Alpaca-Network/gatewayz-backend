"""
Comprehensive tests for src/config/supabase_config.py
"""
...
class TestDatabaseConfig:
    ...
    def test_default_configuration(self, monkeypatch):
        ...
        from src.config.supabase_config import DatabaseConfig
    ...
    def test_custom_configuration(self, monkeypatch):
        ...
        import src.config.supabase_config as db_config_mod
...
class TestConnectionPool:
    ...
    @patch("src.config.supabase_config.PSYCOPG2_AVAILABLE", True)
    ...
    @patch("src.config.supabase_config.PSYCOPG2_AVAILABLE", False)
