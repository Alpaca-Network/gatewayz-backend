...
class TestXSSPrevention:
    ...
    def test_xss_in_chat_message(self, client):
        ...
        response = client.post(
            "/v1/chat/completions",
            json={"model": "gpt-3.5-turbo", "messages": [{"role": "user", "content": xss_payload}]},
...
class TestCommandInjection:
    ...
    def test_command_injection_in_model_name(self, client):
        ...
        response = client.post(
            "/v1/chat/completions",
            json={"model": cmd_payload, "messages": [{"role": "user", "content": "test"}]},
            headers={"Authorization": "Bearer gw_test_key"},
        )
...
class TestHeaderInjection:
    ...
    def test_crlf_injection_in_header(self, client):
        ...
        headers = {"X-Custom-Header": malicious_header, "Authorization": "Bearer gw_test_key"}
