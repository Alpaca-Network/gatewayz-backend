...
def mock_user():
    ...
    return {"id": "1", "username": "testuser", "email": "test@example.com", "credits": 100.0}
...
class TestApiKeyCreation:
    ...
    def test_create_api_key_success(
        ...
        response = client.post(
            "/user/api-keys", json=request_data, headers={"Authorization": f"Bearer {mock_api_key}"}
        )
    ...
    def test_create_api_key_insufficient_permissions(
        self, mock_validate_perms, mock_get_user, client, mock_api_key, mock_user
    ):
    ...
    def test_create_api_key_duplicate_name(
        self, mock_create_key, mock_validate_perms, mock_get_user, client, mock_api_key, mock_user
    ):
...
class TestApiKeyUpdate:
    ...
    def test_update_api_key_success(
        ...
        request_data = {"key_name": "Updated Key Name"}
    ...
    def test_update_api_key_not_found(
        ...
        request_data = {"key_name": "Updated Name"}
    ...
    def test_bulk_rotate_api_keys_success(
        ...
        request_data = {"action": "bulk_rotate", "environment_tag": "live"}
...
class TestApiKeyListing:
    ...
    def test_list_api_keys_success(
        ...
        response = client.get("/user/api-keys", headers={"Authorization": f"Bearer {mock_api_key}"})
    ...
    def test_list_api_keys_empty(
        self, mock_get_keys, mock_validate_perms, mock_get_user, client, mock_api_key, mock_user
    ):
...
class TestApiKeyDeletion:
    ...
    def test_delete_api_key_success(
        ...
        delete_data = {"confirmation": "DELETE_KEY"}
...
class TestApiKeyUsage:
    ...
    def test_get_usage_stats_success(
        self, mock_get_usage, mock_get_user, client, mock_api_key, mock_user, mock_usage_stats
    ):
        ...
        response = client.get(
            "/user/api-keys/usage", headers={"Authorization": f"Bearer {mock_api_key}"}
        )
    ...
    def test_get_usage_stats_failed(
        self, mock_get_usage, mock_get_user, client, mock_api_key, mock_user
    ):
    ...
    @patch("src.routes.api_keys.get_user")
    def test_get_usage_stats_invalid_key(self, mock_get_user, client):
        """Test usage stats with invalid API key"""
        mock_get_user.return_value = None

        response = client.get(
            "/user/api-keys/usage", headers={"Authorization": "Bearer invalid-key"}
        )
...
class TestApiKeyIntegration:
    ...
    def test_complete_key_lifecycle(
        ...
        list_response = client.get(
            "/user/api-keys", headers={"Authorization": f"Bearer {mock_api_key}"}
        )
