...
class TestGetTransactionAnalytics:
    ...
    async def test_get_transaction_analytics_success(
        self, mock_httpx_client, client, mock_openrouter_response
    ):
    ...
    async def test_get_transaction_analytics_missing_cookie(self, client):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_analytics_auth_failure(self, mock_httpx_client, client):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_analytics_api_error(self, mock_httpx_client, client):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_analytics_timeout(self, mock_httpx_client, client):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_analytics_request_error(self, mock_httpx_client, client):
...
class TestGetTransactionSummary:
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_summary_empty_data(self, mock_httpx_client, client):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_summary_with_reasoning_tokens(self, mock_httpx_client, client):
    ...
    @pytest.mark.asyncio
    @patch("httpx.AsyncClient")
    async def test_get_transaction_summary_error_propagation(self, mock_httpx_client, client):
