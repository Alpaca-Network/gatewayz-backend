...
def test_health_timeline_uses_correct_supabase_import():
    ...
    assert "get_supabase_admin" not in source, "Should not import get_supabase_admin (doesn't exist)"
...
def test_supabase_config_exports():
    ...
    assert not hasattr(supabase_config, 'get_supabase_admin'), "Should NOT export get_supabase_admin"
