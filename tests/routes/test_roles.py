...
def mock_admin_user():
    ...
    return {"id": 456, "username": "admin", "email": "admin@example.com", "role": "admin"}
...
def mock_developer_user():
    """Mock developer user"""
    return {"id": 789, "username": "developer", "email": "dev@example.com", "role": "developer"}
...
class TestUpdateUserRole:
    ...
    def test_update_role_success(
        self, mock_require_admin, mock_update_role, client, mock_admin_user
    ):
        ...
        response = client.post(
            "/admin/roles/update",
            json={"user_id": 123, "new_role": "developer", "reason": "Promoted to developer"},
        )
        ...
        mock_update_role.assert_called_once_with(
            user_id=123, new_role="developer", changed_by=456, reason="Promoted to developer"
        )
    ...
    def test_update_role_without_reason(
        ...
        response = client.post("/admin/roles/update", json={"user_id": 123, "new_role": "admin"})
    ...
    @patch("src.routes.roles.require_admin")
    def test_update_role_invalid_role(self, mock_require_admin, client, mock_admin_user):
        """Test updating to invalid role"""
        mock_require_admin.return_value = mock_admin_user

        response = client.post(
            "/admin/roles/update", json={"user_id": 123, "new_role": "superadmin"}  # Invalid
        )
    ...
    def test_update_role_failure(
        ...
        response = client.post(
            "/admin/roles/update", json={"user_id": 999, "new_role": "developer"}
        )
    ...
    def test_update_role_exception(
        ...
        response = client.post(
            "/admin/roles/update", json={"user_id": 123, "new_role": "developer"}
        )
...
class TestGetUserRoleInfo:
    ...
    def test_get_user_role_info_success(
        self, mock_require_admin, mock_get_role, mock_get_permissions, client, mock_admin_user
    ):
    ...
    def test_get_user_role_info_not_found(
        self, mock_require_admin, mock_get_role, client, mock_admin_user
    ):
...
class TestRoleAuditLog:
    ...
    @patch("src.routes.roles.require_admin")
    def test_get_audit_log_all(self, mock_require_admin, mock_get_log, client, mock_admin_user):
    ...
    @patch("src.routes.roles.get_role_audit_log")
    @patch("src.routes.roles.require_admin")
    def test_get_audit_log_by_user(self, mock_require_admin, mock_get_log, client, mock_admin_user):
    ...
    def test_get_audit_log_with_limit(
        self, mock_require_admin, mock_get_log, client, mock_admin_user
    ):
    ...
    @patch("src.routes.roles.get_role_audit_log")
    @patch("src.routes.roles.require_admin")
    def test_get_audit_log_empty(self, mock_require_admin, mock_get_log, client, mock_admin_user):
...
class TestListUsersByRole:
    ...
    def test_list_users_by_role_success(
        self, mock_require_admin, mock_get_users, client, mock_admin_user
    ):
    ...
    @patch("src.routes.roles.require_admin")
    def test_list_users_invalid_role(self, mock_require_admin, client, mock_admin_user):
    ...
    @patch("src.routes.roles.get_users_by_role")
    @patch("src.routes.roles.require_admin")
    def test_list_users_empty(self, mock_require_admin, mock_get_users, client, mock_admin_user):
...
class TestGetRolePermissions:
    ...
    def test_get_role_permissions_success(
        self, mock_require_admin, mock_get_permissions, client, mock_admin_user
    ):
    ...
    @patch("src.routes.roles.require_admin")
    def test_get_role_permissions_invalid_role(self, mock_require_admin, client, mock_admin_user):
...
class TestRoleAuthorization:
    ...
    @patch("src.routes.roles.require_admin")
    def test_all_endpoints_require_admin(self, mock_require_admin, client):
        ...
        mock_require_admin.side_effect = HTTPException(
            status_code=403, detail="Requires admin role"
        )
...
class TestRoleManagementIntegration:
    ...
    def test_role_update_creates_audit_entry(
        self, mock_require_admin, mock_update_role, mock_get_log, client, mock_admin_user
    ):
        ...
        update_response = client.post(
            "/admin/roles/update",
            json={"user_id": 123, "new_role": "developer", "reason": "Promoted"},
        )
    ...
    def test_role_update_affects_user_list(
        self, mock_require_admin, mock_update_role, mock_get_users, client, mock_admin_user
    ):
        ...
        client.post("/admin/roles/update", json={"user_id": 123, "new_role": "developer"})

        # Now one developer
        mock_get_users.return_value = [{"id": 123, "username": "testuser", "role": "developer"}]
