...
class TestTrialStatusDefenseInDepth:
    ...
    def test_trial_override_with_active_stripe_subscription(
        self, mock_get_user, mock_track_trial, mock_validate_trial,
        mock_make_request, mock_process, mock_calculate_cost,
        mock_deduct, mock_record, client, payload_basic, auth_headers
    ):
