...
def mock_deepinfra_response():
    ...
    return {
        "created": 1677652288,
        "data": [{"url": "https://cdn.deepinfra.com/image123.png", "b64_json": None}],
    }
...
def mock_fal_response():
    ...
    return {
        "created": 1677652288,
        "data": [{"url": "https://fal.media/files/elephant/image789.png", "b64_json": None}],
    }
...
class TestImageGenerationAuth:
    ...
    def test_generate_image_no_auth_header(self, mock_get_user, client, valid_image_request):
        ...
        response = client.post("/v1/images/generations", json=valid_image_request)
...
class TestImageGenerationCredits:
    ...
    def test_generate_image_insufficient_credits(
        self, mock_get_user, client, mock_user_no_credits, valid_image_request
    ):
    ...
    def test_generate_image_insufficient_credits_multiple(
        self, mock_get_user, client, mock_user_no_credits
    ):
...
class TestImageGenerationValidation:
    ...
    def test_generate_image_invalid_size(self, client):
        ...
        request_data = {"prompt": "Test prompt", "size": "invalid_size", "n": 1}
    ...
    def test_generate_image_invalid_n(self, client):
        ...
        request_data = {"prompt": "Test prompt", "n": 0}  # Invalid: must be positive
...
class TestImageGenerationProviders:
    ...
    def test_default_provider_is_deepinfra(
        ...
        request_data = {"prompt": "Test prompt", "n": 1}
    ...
    def test_unsupported_provider_error(self, mock_get_user, client, mock_user):
        ...
        request_data = {"prompt": "Test prompt", "provider": "unsupported_provider", "n": 1}
...
class TestImageGenerationErrorHandling:
    ...
    def test_provider_error_handling(
        self, mock_make_request, mock_get_user, client, mock_user, valid_image_request
    ):
