...
class TestAutoSentryMiddleware:
    ...
    # NOTE: Tests that called middleware.dispatch() directly were removed because
    # AutoSentryMiddleware uses __call__ (raw ASGI), not dispatch (BaseHTTPMiddleware).
    # The middleware is tested through TestClient in the tests above.
