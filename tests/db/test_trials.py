...
class TestStartTrial:
    ...
    def test_start_trial_success(
        self, mock_get_client, mock_supabase_client, mock_api_key, mock_api_key_data
    ):
        ...
        client.rpc.assert_called_once_with("start_trial", {"api_key_id": 1, "trial_days": 14})
    ...
    def test_start_trial_custom_duration(
        ...
        client.rpc.assert_called_once_with("start_trial", {"api_key_id": 1, "trial_days": 30})

    @patch("src.db.trials.get_supabase_client")
    def test_start_trial_api_key_not_found(
        self, mock_get_client, mock_supabase_client, mock_api_key
    ):
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_start_trial_exception(self, mock_get_client, mock_supabase_client, mock_api_key):
...
class TestGetTrialStatus:
    ...
    def test_get_trial_status_not_trial(
        ...
        status_result = {"is_trial": False, "trial_active": False}
        rpc_mock.execute.return_value = Mock(data=status_result)
...
class TestConvertTrialToPaid:
    ...
    def test_convert_trial_to_paid_success(
        ...
        client.rpc.assert_called_once_with(
            "convert_trial_to_paid", {"api_key_id": 1, "plan_name": "pro"}
        )
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_convert_trial_exception(self, mock_get_client, mock_supabase_client, mock_api_key):
...
class TestTrackTrialUsage:
    ...
    def test_track_trial_usage_success(
        ...
        client.rpc.assert_called_once_with(
            "track_trial_usage", {"api_key_id": 1, "tokens_used": 1500, "requests_used": 1}
        )
    ...
    def test_track_trial_usage_custom_requests(
        ...
        result = track_trial_usage_for_key(mock_api_key, tokens_used=5000, requests_used=5)

        # Verify custom requests count
        client.rpc.assert_called_once_with(
            "track_trial_usage", {"api_key_id": 1, "tokens_used": 5000, "requests_used": 5}
        )
...
class TestTrialAnalytics:
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_get_trial_analytics_success(self, mock_get_client, mock_supabase_client):
        ...
        trial_data = [
            ...
            {"is_trial": False, "subscription_status": "active"},  # Not a trial
        ]
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_get_trial_analytics_no_trials(self, mock_get_client, mock_supabase_client):
        ...
        table_mock.execute.return_value = Mock(
            data=[{"is_trial": False, "subscription_status": "active"}]
        )
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_get_trial_analytics_no_data(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_get_trial_analytics_calculates_averages(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.trials.get_supabase_client")
    def test_get_trial_analytics_exception(self, mock_get_client, mock_supabase_client):
