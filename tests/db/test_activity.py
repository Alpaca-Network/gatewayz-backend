...
class TestLogActivity:
    ...
    def test_log_activity_success(self, mock_get_client, mock_supabase_client, mock_activity_data):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_log_activity_with_defaults(self, mock_get_client, mock_supabase_client):
        ...
        result = log_activity(
            user_id=123, model="claude-3-sonnet", provider="Anthropic", tokens=2000, cost=0.06
        )
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_log_activity_no_data(self, mock_get_client, mock_supabase_client):
        ...
        result = log_activity(
            user_id=123, model="gpt-4", provider="OpenAI", tokens=1500, cost=0.045
        )

        assert result is None

    @patch("src.db.activity.get_supabase_client")
    def test_log_activity_error(self, mock_get_client, mock_supabase_client):
...
class TestActivityStatistics:
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_stats_with_data(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_stats_empty(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_stats_with_date_range(self, mock_get_client, mock_supabase_client):
        ...
        stats = get_user_activity_stats(user_id=123, from_date="2024-01-01", to_date="2024-01-31")
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_stats_default_30_days(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_stats_error(self, mock_get_client, mock_supabase_client):
...
class TestActivityLogRetrieval:
    ...
    def test_get_activity_log_success(
        self, mock_get_client, mock_supabase_client, mock_activity_data
    ):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_log_with_pagination(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_log_with_date_filters(self, mock_get_client, mock_supabase_client):
        ...
        result = get_user_activity_log(user_id=123, from_date="2024-01-01", to_date="2024-01-31")
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_log_with_model_filter(self, mock_get_client, mock_supabase_client):
        ...
        result = get_user_activity_log(user_id=123, model_filter="gpt-4")
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_log_with_provider_filter(self, mock_get_client, mock_supabase_client):
        ...
        result = get_user_activity_log(user_id=123, provider_filter="OpenAI")
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_log_empty(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.activity.get_supabase_client")
    def test_get_activity_log_error(self, mock_get_client, mock_supabase_client):
