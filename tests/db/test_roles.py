...
class TestPermissionChecking:
    ...
    def test_check_user_permission_granted(self, mock_get_client, mock_supabase_client):
        ...
        has_permission = check_user_permission(user_id=123, resource="api_keys", action="create")

        assert has_permission is True
        client.rpc.assert_called_once_with(
            "user_has_permission",
            {"p_user_id": 123, "p_resource": "api_keys", "p_action": "create"},
        )

    @patch("src.db.roles.get_supabase_client")
    def test_check_user_permission_denied(self, mock_get_client, mock_supabase_client):
        ...
        has_permission = check_user_permission(user_id=123, resource="admin_panel", action="access")

        assert has_permission is False

    @patch("src.db.roles.get_supabase_client")
    def test_check_user_permission_no_data(self, mock_get_client, mock_supabase_client):
        ...
        has_permission = check_user_permission(user_id=123, resource="unknown", action="unknown")

        assert has_permission is False

    @patch("src.db.roles.get_supabase_client")
    def test_check_user_permission_error(self, mock_get_client, mock_supabase_client):
    ...
    def test_get_user_permissions_success(
        self, mock_get_client, mock_supabase_client, mock_permission_data
    ):
        ...
        client.rpc.assert_called_once_with("get_user_permissions", {"p_user_id": 123})

    @patch("src.db.roles.get_supabase_client")
    def test_get_user_permissions_empty(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_user_permissions_error(self, mock_get_client, mock_supabase_client):
...
class TestUserRoleManagement:
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_user_role_success(self, mock_get_client, mock_supabase_client, mock_user_data):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_user_role_not_found(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_user_role_error(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_update_user_role_success(self, mock_get_client, mock_supabase_client, mock_user_data):
        ...
        success = update_user_role(
            user_id=123, new_role=UserRole.DEVELOPER, changed_by=456, reason="Promoted to developer"
        )
    ...
    def test_update_user_role_with_audit_log(
        self, mock_get_client, mock_supabase_client, mock_user_data
    ):
        ...
        success = update_user_role(
            user_id=123, new_role=UserRole.ADMIN, changed_by=456, reason="Promoted to admin"
        )
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_update_user_role_invalid_role(self, mock_get_client, mock_supabase_client):
        """Test updating to invalid role"""
        client, table_mock, rpc_mock = mock_supabase_client
        mock_get_client.return_value = client

        success = update_user_role(
            user_id=123, new_role="superadmin", changed_by=456  # Invalid role
        )

        assert success is False

    @patch("src.db.roles.get_supabase_client")
    def test_update_user_role_no_data(self, mock_get_client, mock_supabase_client):
        ...
        success = update_user_role(user_id=999, new_role=UserRole.DEVELOPER)

        assert success is False

    @patch("src.db.roles.get_supabase_client")
    def test_update_user_role_error(self, mock_get_client, mock_supabase_client):
        ...
        success = update_user_role(user_id=123, new_role=UserRole.DEVELOPER)
...
class TestRoleAuditLog:
    ...
    def test_get_role_audit_log_all(
        self, mock_get_client, mock_supabase_client, mock_audit_log_data
    ):
        ...
        audit_logs = [mock_audit_log_data, {**mock_audit_log_data, "id": 2, "user_id": 456}]
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_role_audit_log_empty(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_role_audit_log_error(self, mock_get_client, mock_supabase_client):
...
class TestUsersByRole:
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_users_by_role_success(self, mock_get_client, mock_supabase_client, mock_user_data):
        """Test retrieving users with specific role"""
        client, table_mock, rpc_mock = mock_supabase_client
        mock_get_client.return_value = client

        # Mock users response
        users = [mock_user_data, {**mock_user_data, "id": 124, "username": "testuser2"}]
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_users_by_role_admin(self, mock_get_client, mock_supabase_client, mock_admin_data):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_users_by_role_empty(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_users_by_role_error(self, mock_get_client, mock_supabase_client):
...
class TestRolePermissionsManagement:
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_get_role_permissions_empty(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_add_role_permission_success(self, mock_get_client, mock_supabase_client):
        ...
        success = add_role_permission(role=UserRole.DEVELOPER, resource="api_keys", action="create")
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_add_role_permission_no_data(self, mock_get_client, mock_supabase_client):
        ...
        success = add_role_permission(role=UserRole.USER, resource="api_keys", action="read")

        assert success is False

    @patch("src.db.roles.get_supabase_client")
    def test_add_role_permission_error(self, mock_get_client, mock_supabase_client):
        ...
        success = add_role_permission(role=UserRole.DEVELOPER, resource="api_keys", action="delete")

        assert success is False

    @patch("src.db.roles.get_supabase_client")
    def test_remove_role_permission_success(self, mock_get_client, mock_supabase_client):
        ...
        success = remove_role_permission(
            role=UserRole.USER, resource="admin_panel", action="access"
        )
    ...
    @patch("src.db.roles.get_supabase_client")
    def test_remove_role_permission_no_data(self, mock_get_client, mock_supabase_client):
        ...
        success = remove_role_permission(
            role=UserRole.DEVELOPER, resource="api_keys", action="delete"
        )

        assert success is False

    @patch("src.db.roles.get_supabase_client")
    def test_remove_role_permission_error(self, mock_get_client, mock_supabase_client):
        ...
        success = remove_role_permission(role=UserRole.USER, resource="api_keys", action="create")
