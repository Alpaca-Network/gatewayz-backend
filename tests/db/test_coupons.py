...
class TestCreateCoupon:
    ...
    def test_create_global_coupon_success(
        self, mock_get_client, mock_supabase_client, mock_coupon_data
    ):
    ...
    def test_create_user_specific_coupon_success(
        self, mock_get_client, mock_supabase_client, mock_user_specific_coupon
    ):
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_create_global_coupon_with_user_id_fails(self, mock_get_client, mock_supabase_client):
...
class TestGetCoupon:
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_get_coupon_by_code_not_found(self, mock_get_client, mock_supabase_client):
    ...
    def test_list_coupons_all(
        self, mock_get_client, mock_supabase_client, mock_coupon_data, mock_user_specific_coupon
    ):
    ...
    def test_list_coupons_with_filters(
        ...
        result = list_coupons(scope="global", coupon_type="promotional", is_active=True)
...
class TestUpdateCoupon:
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_update_coupon_success(self, mock_get_client, mock_supabase_client, mock_coupon_data):
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_update_coupon_filters_invalid_fields(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_deactivate_coupon_success(self, mock_get_client, mock_supabase_client):
...
class TestValidateCoupon:
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_validate_coupon_valid(self, mock_get_client, mock_supabase_client):
        ...
        client.rpc.assert_called_once_with(
            "is_coupon_redeemable", {"p_coupon_code": "WELCOME2024", "p_user_id": 123}
        )

    @patch("src.db.coupons.get_supabase_client")
    def test_validate_coupon_invalid(self, mock_get_client, mock_supabase_client):
...
class TestRedeemCoupon:
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_redeem_coupon_success(self, mock_get_client, mock_validate, mock_supabase_client):
    ...
    @patch("src.db.coupons.validate_coupon")
    def test_redeem_coupon_invalid(self, mock_validate):
...
class TestUserCouponQueries:
    ...
    def test_get_available_coupons_for_user(
        ...
        client.rpc.assert_called_once_with("get_available_coupons", {"p_user_id": 123})

    @patch("src.db.coupons.get_supabase_client")
    def test_get_user_redemption_history(self, mock_get_client, mock_supabase_client):
...
class TestCouponAnalytics:
    ...
    def test_get_coupon_analytics(
        self, mock_get_client, mock_get_coupon, mock_supabase_client, mock_coupon_data
    ):
    ...
    def test_get_all_coupons_stats(
        ...
        def table_side_effect(table_name):
            ...
            if table_name == "coupons":
                mock.execute.return_value = Mock(data=[mock_coupon_data, mock_user_specific_coupon])
...
class TestCouponErrorHandling:
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_get_coupon_by_code_error(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_list_coupons_error(self, mock_get_client, mock_supabase_client):
    ...
    @patch("src.db.coupons.get_supabase_client")
    def test_validate_coupon_error(self, mock_get_client, mock_supabase_client):
