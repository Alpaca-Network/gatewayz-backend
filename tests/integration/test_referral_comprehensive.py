...
class TestReferralNotifications:
    ...
    def test_send_referral_signup_notification(self, mock_templates, mock_notification_service):
        ...
        mock_templates.get_base_template.return_value.format.return_value = (
...
class TestReferralBonusWithPendingRecord:
    ...
    def test_apply_bonus_updates_pending_referral(self):
        ...
        """
        from src.services.referral import REFERRAL_BONUS, apply_referral_bonus
        ...
        print(
            "[INFO] Full integration test in test_e2e_referral.py and test_referral_database_integrity.py"
        )
...
class TestTrialCredits:
    ...
    def test_new_user_gets_trial_credits(self, mock_create_key, mock_client):
        ...
        user_data = create_enhanced_user(
            username="testuser", email="test@example.com", auth_method="email", credits=5
        )
